...
import { Grid, Box, Typography, Pagination, LinearProgress } from "@mui/material";

import { fetchAllCourses, fetchDeleteCourseById, fetchTotalPagesCount } from "../api/courseService";
import { removeFromCart } from "../features/cartSlice";
import OneCourse from "../componnents/OneCourse";
...
const CoursesList = () => {
    ...
    const handlePageChange = (_, page) => {
        setCurrentPage(page);
        localStorage.setItem("currentPage", page); // שמירה של העמוד הנוכחי ב-localStorage
    }
