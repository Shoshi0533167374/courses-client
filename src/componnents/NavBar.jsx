...
import { AppBar, Toolbar, Button, Typography, Box, IconButton, Drawer, List, ListItem, ListItemIcon, ListItemText, Avatar } from '@mui/material';
import { Menu, Home, ShoppingCart, Payment, Add, PersonAdd, Login, Logout } from '@mui/icons-material';
import { purple, green, blue, orange, deepOrange, grey, pink, yellow, lightBlue, red, brown, cyan, teal, common } from '@mui/material/colors';
...
const NavBar = () => {
    ...
    const getColorByInitial = (initial) => {
        ...
        return colorsMap[initial?.toUpperCase()] || pink[200]; // ברירת מחדל לצבע אפור כהה
    };
